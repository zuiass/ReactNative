...
export default function Home() {
    ...
    return (
        <View className="flex-1 bg-gray-100">
            <View className="w-full h-[75px] p-4 bg-gray-800 flex items-center flex-row justify-center">
                <Text className="text-4x1 color-white">Olá, {nome}</Text>
            </View>

            <ScrollView className="p-4">
                {produtos.map(produto => (

                    <View key={produto.id} className="flex mb-4 bg-white rounded-lg shadow-sm flex-row p-3 items-center">
                        <Image
                        ...
                        <View className="flex-1 ml-4 justify-between">
                            ...
                            <TouchableOpacity  className="bg-gray-700 rounded-md py-2 mt-2">
